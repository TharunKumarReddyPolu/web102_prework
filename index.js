...
const unfundedGamesDescription = `We currently have ${numUnfundedGames} ${numUnfundedGames === 1 ? 'game' : 'games'} seeking funding.`;
...
console.log(firstWordMostFunded, firstWordSecondMostFunded);
